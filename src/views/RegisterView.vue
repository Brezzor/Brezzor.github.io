            ...
            <form @submit.prevent>
              ...
              <div class="mb-3">
                ...
                <div class="input-group">
                  <input :type="inputType" name="password" id="loginPassword" :placeholder="$t('RegisterPage.Password')"
              ...
              <div class="mb-3">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" name="registerRemember" id="registerRemember"
              ...
              <div class="mb-3">
                <button class="btn btn-primary" v-on:click="authStore.registerUser(email, password)">
                  {{ $t('Register') }}
                </button>
              </div>
              <div>
                <span>{{ $t('RegisterPage.LoginMessage.First') }}? </span>
                <RouterLink :to="{ name: 'Login' }">{{ $t('RegisterPage.LoginMessage.Second') }}
                </RouterLink>
              </div>
            </form>
          </div>
